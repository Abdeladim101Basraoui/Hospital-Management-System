...
<body>
    ...
    <div class="chat_icon">
        ...
        <img src="firstpage/images/chatboot.gif" alt="" width="220" height="180">
    </div>
    ...
    <div id="topbar" class="d-flex align-items-center fixed-top">
        <div class="container d-flex justify-content-between">
            <div class="contact-info d-flex align-items-center">
                ...
                <i class="bi bi-phone"></i> +212 661-704299
            </div>
    ...
    <header id="header" class="fixed-top">
        <div class="container d-flex align-items-center">
            ...
            <h1 class="logo me-auto"><a href="index.html">AL AMAL</a></h1>
            ...
            <nav id="navbar" class="navbar order-last order-lg-0">
                <ul>
                    ...
                    <!--li><a class="nav-link scrollto" href="#doctors">Login</a></li>
                    <li><a class="nav-link scrollto" href="#doctors">Register</a></li-->
                    ...
                    <li></li><a href="#appointment" class="nav-link scrollto">Make an Appointment</a></li>
            ...
            <a href="login_form/login.php" class="appointment-btn scrollto"><span class="d-none d-md-inline">Login</span></a>
            <a href="login_form/register.php" class="appointment-btn scrollto"><span class="d-none d-md-inline">Register</span></a>
    ...
    <section id="hero" class="d-flex align-items-center">
        <div class="container">
            <h1>Welcome to AL AMAL</h1>
            <h2>Centre de santé "Al Amal" au quartier Yaâcoub Al Mansour à Rabat</h2>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 d-flex align-items-stretch">
                        <div class="content">
                            <h3>Why Choose AL AMAL?</h3>
                            <p>
                            Le centre de santé du deuxième niveau "Al Amal" au quartier Yaâcoub Al Mansour à Rabat relevant de la médecine de famille a lancé ses activités,
Inauguré après des travaux de réaménagement, son équipement par du matériel biomédical, des équipements bureautiques et la mobilisation des ressources humaines qualifiées.
                            </p>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-7 col-lg-6 icon-boxes d-flex flex-column align-items-stretch justify-content-center py-5 px-lg-5">
                        <h3>Lancement des activités du centre de santé “Al Amal”</h3>
                        <p>Le centre de santé du deuxième niveau "Al Amal" au quartier Yaâcoub Al Mansour à Rabat relevant de la médecine de famille a lancé ses activités après son inauguration mercredi par le ministre de la Santé, Anass Doukkali.</p>
                ...
                <div class="row mt-5">
                    ...
                    <div class="col-lg-8 mt-5 mt-lg-0">
                        ...
                        <form action="forms/contact.php" method="post">
                            ...
                            <input class="text-center" type="submit" name="submit" value="Send Message">
                        </form>
    ...
    <footer id="footer">
        ...
        <div class="container d-md-flex py-4">
            ...
            <div class="me-md-auto text-center text-md-start">
                <div class="copyright">
                    &copy; Copyright <strong><span>AL AMAL</span></strong>. All Rights Reserved
                </div>
                <div class="credits">
