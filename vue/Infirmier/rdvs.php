							...
							<table class="table table-border table-striped custom-table datatable mb-0">
								...
								<?php
									...
									foreach($rdv as $con){
										...
										echo "
										<tr>
											<td><img width='28' height='28' src='../../assets/img/user.jpg' class='rounded-circle m-r-5' alt=''>$con[$x][5]</td>
											<td>$con[$x][1]</td>
											<td>$con[$x][2]</td>
											<td>$con[$x][3]</td>
											<td class='text-right'>
                                                <div class='dropdown dropdown-action'>
                                                    ...
                                                    <div class='dropdown-menu dropdown-menu-right'>
                                                        <a class='dropdown-item' href='delete-rdv.php?id=$con[$x][0]'><i class='fa fa-trash m-r-5'></i>Supprimer RDV</a>
                                                    </div>
                                                </div>
											</td>
										</tr>
