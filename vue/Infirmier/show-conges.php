                    ...
                    <ul>
						...
						<li class="submenu">
							...
							<ul style="display: none;">
								...
								<li><a href="consultations.php">Ajouter Patient</a></li>
								<li><a href="consultations.php">RDV</a></li>
							</ul>
						</li>          
                        <li class="submenu">
            ...
            <div class="content">
                <div class="row">
                    <div class="col-sm-4 col-3">
                        <h4 class="page-title">Demandes Congés</h4>
                    </div>
                    <div class="col-sm-8 col-9 text-right m-b-20">
                        <a href="add-conge.php" class="btn btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Add Demande</a>
                    </div>
                </div>
				<div class="row">
					<div class="col-md-12">
											...
											<td class='text-right'>
												<div class='col-sm dropdown dropdown-action'>
													...
													<div class='dropdown-menu dropdown-menu-right'>
														<a class='dropdown-item' href='../update-conge.php?annuler=oui&id=$p[0]&role=I'><i class='fa fa-check m-r-5'></i>Annuler Conge</a>
													</div>
												</div>
											</td>
										</tr>
